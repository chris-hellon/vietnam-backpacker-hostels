...
namespace VietnamBackpackerHostels.UI.Areas.Identity.Pages.Account
{
    public class RegisterModel : BasePageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input.Nationalities = new SelectList(Helpers.GetNationalities(), "Key", "Value", "");
        }
